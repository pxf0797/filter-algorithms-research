...
Covering 10 filter algorithms, Schmitt Trigger, 2 parabolic fit methods, PnL backtesting engine, and time alignment module in `/Users/xfpan/claude/filter_research/filter/streamlit_app.py`.
