...
包含来自 test_feedback_subplot.py 的持仓状态 bands 与反馈子图测试。
"""

import numpy as np
import pandas as pd
from plotly.subplots import make_subplots
from browse.charts import _contiguous_runs, _draw_holding_bands
from browse.app import (
    _add_main_price_traces, _add_residual_traces, _add_schmitt_traces,
    _add_pnl_traces, _add_feedback_subplot, _insert_feedback_row,
)
...
# ── 4. 持仓状态 bands 与反馈子图 (来自 test_feedback_subplot.py) ──
